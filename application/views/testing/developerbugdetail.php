...
<html lang="en">
    <title>
        Manage Bug Details for Developer
    </title>
    <?php
                            ...
                            <div class="col-md-6">
                                <div class="card card-bordered style-primary">
                                    ...
                                    <div class="card-body style-default-bright">
                                        ...
                                        $xcrud->order_by("id");
                                        $xcrud->where("developer_id", $developer_id);
                                        ...
                                        $xcrud->column_pattern('entry_by', "<a href='" . base_url() . "index.php/testing/developerbugdetail/{id}' class='btn btn-warning '>Status</a>");
                                            ...
                                            <div class="form-group floating-label">
                                                <div class="input-group">
                                                    <div class="input-group-content">
                                                        <input type="text" placeholder="Remark" ng-model="developer_comment" id="groupbutton10" class="form-control">

                                                    </div>
                                                    <div class="input-group-btn">
                                                        <button type="button" ng-click="UpdateStatus(<?php echo $bug_id; ?>)" class="btn ink-reaction btn-raised btn-xs btn-success">Done</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="style-default-bright">
                                                        <header class="text-primary">Chat with Tester</header>
                                                        <form class="form">
                                                            <div class="form-group floating-label">
                                                    ...
                                                    <div style="background:  Gainsboro ">
                                                        <div class="nano has-scrollbar" style="height: 222.55px;"><div class="nano-content" tabindex="0" style="right: -13px;"><div class="offcanvas-body">
                                                                    <ul ng-repeat="remarkObj in remark_details1| orderBy:'timestamp':true" class="list-chats">
                                                                        <li ng-if="remarkObj.remarks_from == 'DEVELOPER'">
                                                                            <div class="chat">
                                                                        ...
                                                                        <li ng-if="remarkObj.remarks_from == 'TESTER'" class="chat-left">
                                                                            <div class="chat">
...
<script>
    ...
    var myURL = "<?php echo base_url(); ?>";
    var remark_from = 'DEVELOPER';
    var developer_id = "<?php echo $this->session->userdata('company_staff_id'); ?>";
</script>

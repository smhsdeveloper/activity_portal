...
<html lang="en">
    ...
    <body ng-app="exam" ng-controller="examController" class="ng-cloak">
        <div ng-repeat="x in examdata.questionset">
            <div ng-if="x.examstatus === 'START'">
                <div ng-if="$index == questiontype">
                    {{questiontype}}
                </div>
                                            ...
                                            <div ng-show="$index == questiontype">
                                                ...
                                                <div ng-repeat="questuion in x.queitionsArr">
                                                    <div ng-show="$index == indexcount">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <center><button class="btn btn-default" ng-click="submit($parent.$parent.$index);">Submit Test</button></center>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

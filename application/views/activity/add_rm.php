...
<!DOCTYPE html>
<html lang="en">
    <title>Add Reporting Manager </title>
    <?php
    //echo $class;
                            ...
                            <div class="col-md-8">
                                <div class="card card-bordered style-primary">
                                    <div class="card-head card-head-xs">
                                        ...
                                        <header><i class="fa fa-fw fa-tag"></i>Reporting Manager List</header>
                                    </div><!--end .card-head -->
                                    <div class="card-body style-default-bright">
                                        ...
                                        $xcrud->table('acr_rm_list');
                                        $xcrud->columns("rm_name");
                                        $xcrud->fields("rm_name");
                                        $xcrud->label("rm_name", "Reporting Manager Name");
                                        $xcrud->relation('rm_name', 'company_staff_details', 'name', array("name"));
                                        $xcrud->limit(25);
                            ...
                            <div class="col-md-4">
                                <div class="card card-bordered style-primary">
                                    <div class="card-head card-head-xs">
                                        ...
                                        <header><i class="fa fa-fw fa-tag"></i> How to add a Reporting Manager</header>
                                    </div><!--end .card-head -->
                                    <div class="card-body style-default-bright"> 
                                        1. Click on ADD button to enter a new Reporting Manager.<br>
                                        2. For  delete a Reporting Manager click on the row's  delete button.

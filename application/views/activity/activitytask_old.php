...
<html lang="en">
    ...
    <body class="menubar-hoverable header-fixed ">
        ...
        <div id="base" ng-app="activitytask" ng-controller="activitytaskcontroller">
            <div id="content">
                <section>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <select class="form-control" name="select13" id="select13" ng-model="projectname" ng-init="projectname = 'NA'" ng-change="selectproject()">
                                                    ...
                                                    <div class="form-group" ng-show="type == 'true'">
                                                        ...
                                                        <div class="col-sm-5" ng-show="othermoduleentry == 'true'">
                                                            <input  type="text" id="regular13" class="form-control" ng-model="othermodule">
                                                            <div class="form-control-line"></div>
                                                        </div>
                                                        <div class="col-sm-2" ng-show="othermoduleentry == 'true'">
                                                            <input class="btn ink-reaction btn-raised btn-success btn-sm" type="button" ng-click="savemodule()" value="Save">
                                                            <button class="btn ink-reaction btn-raised btn-danger btn-sm" type="button" ng-click="cancelmodule()">cancel</button>
                                                        </div>
                                                    ...
                                                    <div class="form-group" ng-show="activity == 'true'">
                                                        ...
                                                        <div class="col-sm-5" ng-show="otheractivityentry == 'true'">
                                                            <input  type="text" id="regular13" class="form-control" ng-model="otheractivity">
                                                            <div class="form-control-line"></div>
                                                        </div>
                                                        <div class="col-sm-2" ng-show="otheractivityentry == 'true'">
                                                            <input class="btn ink-reaction btn-raised btn-success btn-sm" type="button" ng-click="saveactivity()" value="Save">
                                                            <button class="btn ink-reaction btn-raised btn-danger btn-sm" type="button" ng-click="cancelactivity()">cancel</button>
                                                        </div>
                                                    ...
                                                    <div class="form-group" ng-show="workentry == 'true'">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <textarea placeholder="" rows="3" class="form-control" id="textarea13" ng-model="textareavalue" name="textarea13"></textarea>
                                                        </div>
                                            ...
                                            <div class="col-sm-12" ng-show="workentry == 'true'">
                                                <div class="form-group">
                                                    <div class="col-sm-7 pull-right">
                                                        <button class="btn ink-reaction btn-raised btn-success" type="button" ng-click="startwork()">Start Work</button>
                                                    </div>
                                ...
                                <div class="card card-bordered style-primary">
                                    <div class="card-body style-default-bright">
                                        ...
                                        <table class="table table-bordered no-margin">
                                            ...
                                            <tbody>
                                                {{json}}
                                                <tr ng-repeat="task in json">
                                                    <td>{{$index + 1}}</td>
                                                    <td>{{task.title}}</td>
                                                    <td>{{task.remarks}}</td>
                                                    <td><span class="pull-right text-bold text-danger" > <p ng-init="mysecond ='{{seconds}}'" ng-model="mysecond">{{mysecond}}</p>
<!--                                                            <timer interval="1000">{{hours}} hour{{hoursS}}, {{minutes}} minute{{minutesS}}, {{seconds}} second{{secondsS}}. <p ng-init="mysecond ='{{seconds}}'" ng-model="mysecond"></p></timer>-->
                                                    <!--<timer start-time="task.starttime">{{hours}} : {{minutes}} : {{seconds}} :<p ng-init="mysecond ='{{seconds}}'" ng-model="mysecond"></p></timer>-->
                                                </span>{{task.starttime}}</td>
                                                    <td><button class="btn btn-success btn-xs" type="button" ng-click="start($index)">Start Work</button>
                                                        <button class="btn btn-danger btn-xs" type="button" ng-click="pause($index)">Pause Work</button></td>
                                                </tr>

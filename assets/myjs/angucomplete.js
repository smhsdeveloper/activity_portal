            ...
            return {
                ...
                link: function ($scope, elem, attrs) {
                    ...
                    $scope.selectResult = function (result) {
                        ...
                        $scope.showDropdown = false;
                        $scope.results = [];
                        if ($scope.selectedObject.originalObject.userid != '' && $scope.selectedObject.originalObject.userid != '-') {
                            window.location = myURL + 'index.php/staff/masterlogin/'+$scope.selectedObject.originalObject.userid;
                        }
                        else{
                            alert('User Id Not Create yet Contact to admin...');
                        }
                        //$scope.$apply();
                    }
